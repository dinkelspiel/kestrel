...
public class GameScene(ClientContext clientContext) : SceneBase(clientContext)
{
    ...
    public override unsafe void Load()
    {
        ...
        Tree = clientContext.World.Create(new TransformComponent(new(220, HeightmapDrawInstruction.Heightmap[220, 220], 220), 0.05f), new ModelRendererComponent(new(clientContext, Path.Combine(AppContext.BaseDirectory, "Assets", "Tree1", "tree1.obj"))));
